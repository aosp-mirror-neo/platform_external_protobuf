...
// Android local modification: this test interacts with static state that
// is clobbered by descriptor_test.cc - it is not compatible with putting
// all tests in the same executable.
TEST_F(LazilyBuildDependenciesTest, DISABLED_GeneratedFile) {
